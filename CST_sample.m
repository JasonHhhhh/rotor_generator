function airfoil_data=CST_sample(doe_w,num)
...
airfoil_data.doe=doe;
airfoil_data.all_points=pp;
airfoil_data.Y=CST_doe_Y;
airfoil_data.N=CST_doe_N;
airfoil_data.scatter=foil;
eval(['save airfoil_data_',num2str(num),' airfoil_data'] ) 
